...
address: "Bizzell Memorial Library, HCLC Classroom LL123, 401 W. Brooks St, Norman, OK 7301"      # full street address of workshop (e.g., "Room A, 123 Forth Street, Blimingen, Euphoria")
...
humandate: "March 18-19, 2019"    # human-readable dates for the workshop (e.g., "Feb 17-18, 2020")
...
enddate: 2019-03-18        # machine-readable end date for the workshop in YYYY-MM-DD format like 2015-01-02
instructor: ["Claire Curry","Zenobie Garrett","Katy Felkner"] # boxed, comma-separated list of instructors' names as strings, like ["Kay McNulty", "Betty Jennings", "Betty Snyder"]
helper: ["Theo Acker","Traci DuBose","Mark Laufersweiler","Michael Malahy","Dawn Nekorchuk","Amanda Schilling","Brent Tweedy"]     # boxed, comma-separated list of helpers' names, like ["Marlyn Wescoff", "Fran Bilas", "Ruth Lichterman"]
...
collaborative_notes: "https://pad.carpentries.org/2019-03-18-ou-dc"             # optional: URL for the workshop collaborative notes, e.g. an Etherpad or Google Docs document
eventbrite: "57230091745"          # optional: alphanumeric key for Eventbrite registration, e.g., "1234567890AB" (if Eventbrite is being used)
---
